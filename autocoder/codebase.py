...
class Codebase:
    ...
    def get_active_branch(self):
        print('Calling method: get_active_branch')
        return self.github_api.active_branch

    def get_issues(self):
        print('Calling method: get_issues')
        return self.github_api.get_issues()

    def create_branch(self, branch: str):
        print('Calling method: create_branch')
    ...
    def read_file_wrapper(self, filepath):
        print('Calling method: read_file_wrapper')
    ...
    def create_file(self, file_query):
        print('Calling method: create_file')
